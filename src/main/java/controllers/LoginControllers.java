...
public class LoginControllers {
        ...
        if (loginSuccess) {
            ...
            if (role != null) {
                if (role.equals("admin")) {
                    ...
                    openDoctorInterface(user);
                } else if (role.equals("patient")) {
                    openPatientInterface(user);
                }
            } else {
                showAlert(Alert.AlertType.ERROR, "Invalid Role", "Invalid user role detected.");
            }
        } else {
    ...
    private void openAdminInterface(User user) throws IOException {
        ...
        rendezvousController.setNomUtilisateur(user.getNomuser(), user.getPrenomuser(), String.valueOf(user.getAgeuser()), user.getSexe(), user.getRole(), user.getEmail(), user.getMdp());
        Scene scene = new Scene(root);
    ...
    private void openDoctorInterface(User user) throws IOException {
    ...
    private void openPatientInterface(User user) throws IOException {
